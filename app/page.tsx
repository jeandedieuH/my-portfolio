    ...
    <div className="center bg-black">
      <div className="menu overflow-hidden">
        ...
        <label className="w-[40px] h-[40px] flex justify-center items-center">
          <X
            className="size-6 text-white flex justify-center items-center cursor-pointer"
            onClick={closeMenu}
          />
        </label>
        {pages.map((page) => (
          <div
            key={page.id}
            className={cn(
              "page text-white overflow-auto",
              isChecked ? `border-4 bg-black rounded-2xl` : "bg-black"
            )}
            id={page.id}
          >
            <div className="head sticky top-0 cursor-pointer z-[99999]">
              ...
              >
                {isChecked || (
                  <AlignJustify className="size-6 mx-2 mt-4 text-white flex justify-center items-center cursor-pointer" />
                )}
              </label>
